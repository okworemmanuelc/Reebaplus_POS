...
// Dark Theme
const Color dBg = Color(0xFF0F172A);
const Color dSurface = Color(0xFF1E293B);
const Color dCard = Color(0xFF334155);
const Color dText = Color(0xFFF8FAFC);
const Color dSubtext = Color(0xFF94A3B8);
const Color dBorder = Color(0xFF475569);
