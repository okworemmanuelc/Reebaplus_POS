...
void main() {
  ...
  setUp(() async {
    ...
    // Cashier: two grants → its card subtitle should read "2 of 32 permissions".
  ...
  testWidgets('renders four role cards with grant counts', (tester) async {
    ...
    expect(find.text('All 32 permissions'), findsOneWidget); // CEO, locked
    expect(find.text('2 of 32 permissions'), findsOneWidget); // Cashier
  });
