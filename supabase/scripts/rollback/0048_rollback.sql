-- =============================================================================
-- 0048_rollback.sql — reverse of 0048_pull_roles_tables.sql.
--
-- Restores pos_pull_snapshot to the 0047 body: the 5 role/membership tables
-- (roles, role_permissions, role_settings, user_businesses, user_stores) are
-- dropped from v_tenant_tables, so a pull stops returning them. No data is
-- touched — the tables themselves remain (they were created in 0042); only
-- the snapshot's table list reverts.
-- =============================================================================
