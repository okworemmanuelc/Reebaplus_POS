-- =============================================================================
-- 0053_rollback.sql — reverse of 0053_pull_invite_codes.sql.
--
-- Restores pos_pull_snapshot to the 0048 body: 'invite_codes' is dropped from
-- v_tenant_tables, so a pull stops returning it. No data is touched — the
-- invite_codes table itself remains (created in 0042); only the snapshot's
-- table list reverts. After this, the Invites tab is creator-device-only again.
-- =============================================================================
